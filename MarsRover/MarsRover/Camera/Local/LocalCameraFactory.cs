...
namespace MarsRover
{
    public class LocalCameraFactory
    {
        ...
        private LocalCameraFactory()
        {
            ...
            LocalCameraDevice c0 = new UDPSenderCameraDevice("127.0.0.1", 3000, f0.Name, f0.MonikerString, 0, 50L);
            Cameras.Add(c0);

            FilterInfo f1 = (FilterInfo)LocalCameraDetector.GetInstance().GetCameraDevices()[1];
            LocalCameraDevice c1 = new UDPSenderCameraDevice("127.0.0.1", 3001, f1.Name, f1.MonikerString, 0, 50L);
            Cameras.Add(c1);
